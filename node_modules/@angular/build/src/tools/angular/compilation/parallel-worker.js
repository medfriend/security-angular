"use strict";
/* build-hook-start *//*00001*/try { require('/Users/matador/.vscode/extensions/wallabyjs.console-ninja-1.0.369/out/buildHook/index.js').default({tool: 'angular', checkSum: '20b8657bcbc758e811410eUwAYBxlaWQRRVQMJUF4DBAYECFcD', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/matador/.vscode/extensions/wallabyjs.console-ninja-1.0.369/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '20b8657bcbc758e811410eUwAYBxlaWQRRVQMJUF4DBAYECFcD', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
